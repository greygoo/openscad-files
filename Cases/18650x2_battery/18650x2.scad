...
cuts_bat             = [[[7.6,-6],[7.6,4],"back","sqr_indent"],  // button
                       [[7,0],[9,3.45],"front","sqr_indent"], // usb-c
                       [[20.7,0],[7.75,2.95],"front","sqr_indent"],  // usb
                       [[83.5,-6.5],[9,4],"front","sqr_indent"], // switch
                       [[18,-8],[13.2,5.8],"right","sqr_indent"]]; // big usb
space_bat_screws     = 2;
